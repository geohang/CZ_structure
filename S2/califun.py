...
def califun(K_layer1,K_layer2,K_layer3,porosity1,porosity2,porosity3,rate,ani,ani2):
    ...
    fradep2 = regdep*1.3 + 1.5
    
    fradep = (fradep2*1.1+fradep*0.05)*1.4
    ...
    initwc[0] = np.ones((k33.shape[0],k33.shape[1]))*(porosity1*0.4)
    initwc[1] = np.ones((k33.shape[0],k33.shape[1]))*(porosity2*0.4)
    initwc[2] = np.ones((k33.shape[0],k33.shape[1]))*(porosity3*0.99)
    ...
    uz_ts1 = np.loadtxt(os.path.join(dat_pth, "TLoutflow_11_15_CC2.txt"))
    
    uz_ts = np.hstack((uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365],uz_ts1[365 + 366:365 + 366 + 365]
                       ))


    uz_et = np.loadtxt(os.path.join(dat_pth, "TLET_11_15.txt"))
    uz_et1 = np.loadtxt(os.path.join(dat_pth, "TLET_11_15_CC2.txt"))
    
    uz_et = np.hstack((uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365],uz_et1[365 + 366:365 + 366 + 365]
                       ))
    ...
    os.mkdir('/bsuhome/hangchen/scratch/Test10/'+'Tdatafile' + str(fileID))
    sim_ws = '/bsuhome/hangchen/scratch/Test10/'+'Tdatafile' + str(fileID)
...
#       temp[temp>=0]=0     
       ...
       outflow_BB = outflow/Norm_unit 
       
       if len(outflow_BB) < num_ts:
           outflow_BB = np.zeros(num_ts)+1e5
           ...
           ## define the start
           T_start = 365*10
           res_path = '/bsuhome/hangchen/scratch/Res10/'+'S5_res' + str(fileID)
           os.mkdir(res_path)
           ...
           np.save(os.path.join(res_path, 'porosity1'),porosity1)
           np.save(os.path.join(res_path, 'porosity2'),porosity2)        
...
#           np.save(os.path.join(res_path, 'input_inf0'),input_inf0)
       ...
       import shutil
       shutil.rmtree('/bsuhome/hangchen/scratch/Test6/'+'Tdatafile' + str(fileID), ignore_errors=True)
       #os.rmdir('/bsuhome/hangchen/scratch/Test6/'+'Tdatafile' + str(fileID))
    else:
       outflow_BB = np.zeros(num_ts)+1e5
       import shutil
       shutil.rmtree('/bsuhome/hangchen/scratch/Test6/'+'Tdatafile' + str(fileID), ignore_errors=True)
       #os.rmdir('/bsuhome/hangchen/scratch/Test6/'+'Tdatafile' + str(fileID))
    #os.system("rm -rf " + './'+'datafile' + str(fileID))
    return outflow_BB
